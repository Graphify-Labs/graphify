...
UNIFIED_DESCRIPTION = (
    "Use when Graphify is explicitly requested, an existing graph can answer a "
    "relational query, or codebase analysis requires cross-file architecture, "
    "dependencies, flows, centrality, or impact. Prefer direct code search for "
    "simple symbol or literal lookup, narrow single-file inspection, and localized edits."
)

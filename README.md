...
| `al` | Microsoft Dynamics 365 Business Central `.al` extraction (full Tree-sitter relationships on Python 3.12+; structural object/procedure/trigger fallback otherwise) | `uv tool install "graphifyy[al]"` |

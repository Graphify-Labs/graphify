...
| Package manifests | `apm.yml` `pyproject.toml` `go.mod` `pom.xml` `Package.swift` — canonical package/dependency nodes; SwiftPM also maps products, package-qualified targets, internal target dependencies, and accepted source membership |

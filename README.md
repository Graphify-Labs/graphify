...
| `al` | Microsoft Dynamics 365 Business Central `.al` extraction (full Tree-sitter objects, permission sets, app dependencies, calls, events, and test-app relationships on Python 3.12+; structural object/procedure/trigger fallback otherwise) | `uv tool install "graphifyy[al]"` |

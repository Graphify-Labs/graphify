...
Works in Claude Code, Codex, OpenCode, Kilo Code, Cursor, Gemini CLI, GitHub Copilot CLI, VS Code Copilot Chat, Aider, Amp, OpenClaw, Factory Droid, Trae, Hermes, Kimi Code, Kiro, Pi, Devin CLI, Qoder CLI, and Google Antigravity.
...
| Qoder CLI | `graphify install --platform qoder` |
...
| Devin CLI | `graphify devin install` |
| Qoder CLI | `graphify qoder install` |
| Google Antigravity | `graphify antigravity install` |
...
graphify qoder install             # .qoder/skills/graphify/ + AGENTS.md (Qoder CLI)
graphify qoder uninstall

...
Use `--out OUTPUT_PATH` when output must live outside the source tree. A successful build activates `OUTPUT_PATH/graphify-out/graph.helix` atomically.
...
See `references/hooks.md` to wire graphify into a project's AGENTS.md.

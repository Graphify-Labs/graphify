"""Groovy extractor. Moved verbatim from graphify/extract.py."""
...
from graphify.extractors.base import _make_id, _file_stem, _read_text
from graphify.extractors.java import _import_java

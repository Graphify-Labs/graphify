"""Go extractor - custom walk for Go files."""
...
from ._utils import make_id, file_stem, _LANGUAGE_BUILTIN_GLOBALS
...
def extract_go(path: Path) -> dict:
    ...
    def walk(node) -> None:
        ...
        if t == "method_declaration":
            ...
            if receiver_type:
                parent_nid = make_id(pkg_scope, receiver_type)
        ...
        if t == "type_declaration":
            for child in node.children:
                ...
                type_nid = make_id(pkg_scope, type_name)

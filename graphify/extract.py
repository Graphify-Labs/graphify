...
from graphify.extractors.lazarus_package import extract_lazarus_package  # noqa: E402,F401
from graphify.extractors.slnx import extract_slnx  # noqa: E402,F401
from graphify.extractors.csproj import extract_csproj  # noqa: E402,F401
from graphify.extractors.base import _shorten_rationale_label  # noqa: E402,F401
from graphify.extractors.xaml import extract_xaml  # noqa: E402,F401
from graphify.extractors.python import _PYTHON_CONFIG, _RATIONALE_PREFIXES, _import_python, _is_autogenerated_python, _extract_python_rationale, extract_python  # noqa: E402,F401
from graphify.extractors.js import _JS_CONFIG, _TS_CONFIG, _TSX_CONFIG, _import_js, _rescue_js_dynamic_imports, _JS_RATIONALE_PREFIXES, _JS_DOC_REF_RE, _JS_COMMENT_LINE_RE, _extract_js_rationale, _resolve_rescued_specifier, _emit_rescued_import, extract_js  # noqa: E402,F401
from graphify.extractors.svelte import extract_svelte  # noqa: E402,F401
from graphify.extractors.astro import extract_astro  # noqa: E402,F401
from graphify.extractors.vue import extract_vue  # noqa: E402,F401
from graphify.extractors.java import _JAVA_CONFIG, _import_java, extract_java  # noqa: E402,F401
from graphify.extractors.groovy import _GROOVY_CONFIG, _is_spock_file, _extract_spock_fallback, extract_groovy  # noqa: E402,F401
from graphify.extractors.c import _C_CONFIG, _get_c_func_name, _import_c, extract_c  # noqa: E402,F401
from graphify.extractors.cpp import _CPP_CONFIG, extract_cpp  # noqa: E402,F401
from graphify.extractors.ruby import _RUBY_CONFIG, extract_ruby  # noqa: E402,F401
from graphify.extractors.csharp import _CSHARP_CONFIG, _import_csharp, extract_csharp  # noqa: E402,F401
from graphify.extractors.kotlin import _KOTLIN_CONFIG, _import_kotlin, extract_kotlin  # noqa: E402,F401
from graphify.extractors.scala import _SCALA_CONFIG, _import_scala, extract_scala  # noqa: E402,F401
from graphify.extractors.php import _PHP_CONFIG, _import_php, extract_php  # noqa: E402,F401
from graphify.extractors.lua import _LUA_CONFIG, _import_lua, extract_lua  # noqa: E402,F401
from graphify.extractors.swift import _SWIFT_CONFIG, _import_swift, extract_swift  # noqa: E402,F401
...
def _safe_extract_with_xaml_root(extractor, path: Path, root: Path) -> dict:
    import graphify.extractors.xaml as _xaml_mod
    previous_root = _xaml_mod._XAML_ACTIVE_EXTRACT_ROOT
    _xaml_mod._XAML_ACTIVE_EXTRACT_ROOT = root.resolve()
    try:
        return _safe_extract(extractor, path)
    finally:
        _xaml_mod._XAML_ACTIVE_EXTRACT_ROOT = previous_root

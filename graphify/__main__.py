...
def _run_cli() -> None:
    ...
    if len(sys.argv) < 2 or sys.argv[1] in ("-h", "--help", "-?"):
        ...
        print("    --memory-limit-mb N     abort when process-tree RSS exceeds N MB (#3011);")
        print("                            exits with code 3 before any partial publish")
        print("                            (also: GRAPHIFY_MEMORY_LIMIT_MB env var)")

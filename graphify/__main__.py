...
def _run_cli() -> None:
    ...
    if len(sys.argv) < 2 or sys.argv[1] in ("-h", "--help", "-?"):
        ...
        print("    --max-concurrency=N     parallel community-labeling LLM calls (default 4; forced to 1 for ollama/claude-cli/copilot-sdk/copilot-cli)")
        ...
        print("    --model=<name>          model to use for community naming")
        print("    --max-concurrency=N     parallel labeling LLM calls (default 4; forced to 1 for ollama/claude-cli/copilot-sdk/copilot-cli)")
        print("    --batch-size=N          communities per labeling LLM call (default 100)")
        ...
        print("    --backend B             gemini|kimi|claude|openai|deepseek|ollama|bedrock|azure|claude-cli|copilot-sdk|copilot-cli")
        print("                            (default: whichever API key is set; CLI backends require explicit selection)")

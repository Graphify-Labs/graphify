...
def _run_cli() -> None:
    ...
    if len(sys.argv) < 2 or sys.argv[1] in ("-h", "--help", "-?"):
        ...
        print("  trust <evidence.json>   atomically evaluate navigation capability evidence")
        print("    --json-out PATH         write the machine-readable trust report")
        print("    --markdown-out PATH     write the human-readable capability table")

...
'INPUT_PATH' | Out-File -FilePath graphify-out\.graphify_root -Encoding utf8 -NoNewline
```
...
save_manifest(detect.get('all_files') or detect['files'], root=Path('INPUT_PATH').resolve())

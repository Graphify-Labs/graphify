...
# webui: стили и разметка разбираются детерминированно, поэтому идут по коду,
# а не через ИИ-проход для документов.
CODE_EXTENSIONS = CODE_EXTENSIONS | {'.css', '.scss', '.html', '.htm'}
